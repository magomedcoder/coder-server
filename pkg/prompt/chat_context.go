...
func AssemblePromptMessages(sessionID int64, systemPolicy *domain.Message, history []*domain.Message, userInstruction *domain.Message, DocumentContextBlocks []DocumentContextBlock) []*domain.Message {
