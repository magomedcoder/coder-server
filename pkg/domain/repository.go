...
type MCPServerRepository interface {
	ListGlobal(ctx context.Context) ([]*domain.MCPServer, error)

	ListForUser(ctx context.Context, userID int) ([]*domain.MCPServer, error)

	ListActive(ctx context.Context) ([]*domain.MCPServer, error)

	GetByID(ctx context.Context, id int64) (*domain.MCPServer, error)

	GetByIDAccessible(ctx context.Context, id int64, userID int) (*domain.MCPServer, error)

	GetGlobalByID(ctx context.Context, id int64) (*domain.MCPServer, error)

	Create(ctx context.Context, s *domain.MCPServer) (*domain.MCPServer, error)

	UpdateGlobal(ctx context.Context, s *domain.MCPServer) error

	UpdateOwned(ctx context.Context, s *domain.MCPServer, ownerUserID int) error
